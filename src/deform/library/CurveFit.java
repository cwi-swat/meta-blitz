...
public class CurveFit {
     ...
     */
    private final static int MAXPOINTS = 100000;
    ...
    public static void main(String[] args) {
        ...
        List<Vec> path = fitCurve(Arrays.asList(d), error);	/*  Fit the Bezier curves */
     ...
     */
    public static List<Vec> fitCurve(List<Vec> dv, double error) {
    	Point2D.Double[] d = new Point2D.Double[dv.size()];
    	for(int i = 0 ; i < dv.size(); i++)
    		d[i] = vec2Point(dv.get(i));
        Point2D.Double tHat1 = new Point2D.Double();
        Point2D.Double tHat2 = new Point2D.Double(); /*  Unit tangent vectors at endpoints */
        List<Vec> bezierPath = new ArrayList<Vec>();
        bezierPath.add(point2Vec(d[0]));
    ...
    private static Point2D.Double vec2Point(Vec v) {
    ...
    private static void fitCubic(Point2D.Double[] d, int first, int last, 
            Point2D.Double tHat1, Point2D.Double tHat2, double error, List<Vec> bezierPath) {
        ...
        if (nPts == 2) {
            ...
            bezierPath.add(point2Vec(bezCurve[1]));
            bezierPath.add(point2Vec(bezCurve[2]));
            bezierPath.add(point2Vec(bezCurve[3]));
    ...
    private static Vec point2Vec(Point2D.Double v) {
...
//            Point2D.Double tHat2, double error, ArrayList<Vec> bezierPath) {
//        Point2D.Double[] bezCurve; /*Control points of fitted Bezier curve*/
//        double[] u;		/*  Parameter values for point  */
//        double[] uPrime;	/*  Improved parameter values */
//        double	maxError;	/*  Maximum fitting error	 */
