...
import paths.crossing.util.BidirectionalOrdering;
import paths.crossing.util.ForwardSegmentMaker;
import paths.crossing.util.IMap;
import paths.crossing.util.ISegmentMaker;
import paths.crossing.util.ISimpleList;
import paths.crossing.util.ReverseSegmentMaker;
import paths.crossing.util.SimpleListView;
import paths.graphtheory.ClosedPathsToShapes;
