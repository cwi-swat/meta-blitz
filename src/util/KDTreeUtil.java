...
public class KDTreeUtil {
	...
	// }
	//
	// public static <A> SplitPlane getBestSplitPlane(List<Event<A>>
	// events,Set<A> all,SplitPlaneFitnessHeuristic<A> heuristic){
	...
	// case Start: right.remove(events.get(i).objectId);
	// inside.add(events.get(i).objectId); break;
	// case Stop: inside.remove(events.get(i).objectId);
	// left.add(events.get(i).objectId); break;
	// }
	// }
	// return best;
	// }
	//
	// public static <A> JudgedObjects<A> judge(List<Event<A>> events,Set<A>
	// all, double split){
	// Set<A> left = new HashSet<A>();
	// Set<A> inside = new HashSet<A>();
	// Set<A> right = new HashSet<A>(all);
	...
	// }
	//
	// public static <A> STuple<List<Event<A>>> splitEvent(List<Event<A>>
	// events, Set<A> left){
	...
	// }
	//
	// public static <A extends HasBBox> STuple<List<Event<A>>>
	// makeEvents(Iterable<A> objects){
	...
	// }
	//
	// public static <A> SplitJudgment<A> judgeSplit(Set<A> all, List<Event<A>>
	// xEvents,
	...
	// }
	// //
	// System.out.printf("All %d Left %d inside %d Right %d\n",all.size(),judged.left.size(),
	// judged.inside.size(), judged.right.size());
	...
	// return new SplitJudgment<A>(judged.left,judged.right, splitXEvents.l,
	// splitYEvents.l, splitXEvents.r, splitYEvents.r);
	// }
	//
	// public static class LeastOverlap<A> implements
	// SplitPlaneFitnessHeuristic<A>{
	// @Override
