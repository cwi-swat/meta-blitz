...
class Sample7{
	final double a,b,c,d,e,f,g;

	Sample7(double a,double b,double c,double d,double e,double f,double g){
		this.a = a;
  this.b = b;
  this.c = c;
  this.d = d;
