...
public interface ICombineTextures4 
	...
	SampleInD extends ISample<SampleInD>> {
	Sample sample(double x, double y, SampleInA ina, SampleInB inb,SampleInC inc, SampleInD ind);	
}